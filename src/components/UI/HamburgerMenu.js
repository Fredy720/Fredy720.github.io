            ...
            <div class={myClass} >
                ...
                <div class="drawer-side">
                    ...
                    <ul class='p-6 pt-20 overflow-y-auto w-80 bg-base-100 flex-col '>
                        <li><a href='#section-projects' class='btn w-full mb-5' onClick={clickHandler}>Proyectos</a> </li>
                        ...
                        <li><a href='#section-about' class='btn w-full mb-5' onClick={clickHandler}>Sobre mí</a> </li>
                        <li><a href='#section-contact' class='btn w-full mb-5' onClick={clickHandler}>Contacto</a> </li>
                    </ul>
                </div>
            </div>
        </>
